...
class Character(models.Model):
    ...
    def _get_hp_percentage(self):
        return floor((float(self.current_HP) / float(self.HP)) * 100)

    hp_percentage = property(_get_hp_percentage)
    ...
    disable_device = models.IntegerField(default=0, verbose_name='Disable Device')
    disguise = models.IntegerField(default=0)
    escape_artist = models.IntegerField(default=0, verbose_name='Escape Artist')
    fly = models.IntegerField(default=0)
    handle_animal = models.IntegerField(default=0, verbose_name='Handle Animal')
    heal = models.IntegerField(default=0)
    intimidate = models.IntegerField(default=0)
    knowledge_arcana = models.IntegerField(default=0, verbose_name='Knowledge (Arcana)')
    knowledge_dungeoneering = models.IntegerField(default=0, verbose_name='Knowledge (Dungeoneering)')
    knowledge_engineering = models.IntegerField(default=0, verbose_name='Knowledge (Engineering)')
    knowledge_geography = models.IntegerField(default=0, verbose_name='Knowledge (Geography)')
    knowledge_history = models.IntegerField(default=0, verbose_name='Knowledge (History)')
    knowledge_local = models.IntegerField(default=0, verbose_name='Knowledge (Local)')
    knowledge_nature = models.IntegerField(default=0, verbose_name='Knowledge (Nature)')
    knowledge_nobility = models.IntegerField(default=0, verbose_name='Knowledge (Nobility)')
    knowledge_planes = models.IntegerField(default=0, verbose_name='Knowledge (Planes)')
    knowledge_religion = models.IntegerField(default=0, verbose_name='Knowledge (Religion)')
    linguistics = models.IntegerField(default=0)
    perception = models.IntegerField(default=0)
    ride = models.IntegerField(default=0)
    sense_motive = models.IntegerField(default=0, verbose_name='Sense Motive')
    sleight_of_hand = models.IntegerField(default=0, verbose_name='Sleight of Hand')
    spellcraft = models.IntegerField(default=0)
    stealth = models.IntegerField(default=0)
    survival = models.IntegerField(default=0)
    swim = models.IntegerField(default=0)
    use_magic_device = models.IntegerField(default=0, verbose_name='Use Magic Device')